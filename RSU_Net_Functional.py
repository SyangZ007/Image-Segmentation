...
def REBNCONV(in_ch,out_ch,dilate_rate,input_tensor):
...
def RSU7(in_ch, mid_ch, out_ch, input_tensor):
    hxin = REBNCONV(in_ch,out_ch,1,input_tensor)
    hx1 = REBNCONV(out_ch,mid_ch,1,hxin)
    hx = layers.MaxPool2D(pool_size=2,strides=2,padding='same')(hx1)
    hx2 = REBNCONV(mid_ch,mid_ch,1,hx)
    hx = layers.MaxPool2D(pool_size=2,strides=2,padding='same')(hx2)
    hx3 = REBNCONV(mid_ch,mid_ch,1,hx)
    hx = layers.MaxPool2D(pool_size=2,strides=2,padding='same')(hx3)
    hx4 = REBNCONV(mid_ch,mid_ch,1,hx)
    hx = layers.MaxPool2D(pool_size=2,strides=2,padding='same')(hx4)
    hx5 = REBNCONV(mid_ch,mid_ch,1,hx)
    hx = layers.MaxPool2D(pool_size=2,strides=2,padding='same')(hx5)
    hx6 = REBNCONV(mid_ch,mid_ch,1,hx)
    hx7 = REBNCONV(mid_ch,mid_ch,2,hx6)#######bottle neck#########
    #######此处为RSU 块的bottle_neck
    hx6d = REBNCONV(mid_ch*2,mid_ch,1,tf.concat([hx7,hx6],-1))
    hx6dup = _upsample_like(hx6d,hx5)
    hx5d = REBNCONV(mid_ch*2,mid_ch,1,tf.concat([hx6dup,hx5],-1))
    hx5dup = _upsample_like(hx5d,hx4)
    hx4d = REBNCONV(mid_ch*2,mid_ch,1,tf.concat([hx5dup,hx4],-1))
    hx4dup = _upsample_like(hx4d,hx3)
    hx3d = REBNCONV(mid_ch*2,mid_ch,1,tf.concat([hx4dup,hx3],-1))
    hx3dup = _upsample_like(hx3d,hx2)
    hx2d = REBNCONV(mid_ch*2,mid_ch,1,tf.concat([hx3dup,hx2],-1))
    hx2dup = _upsample_like(hx2d,hx1)
    hx1d = REBNCONV(mid_ch*2,out_ch,1,tf.concat([hx2dup,hx1],-1))
    return hx1d + hxin
  
def RSU6(in_ch, mid_ch, out_ch, input_tensor):
    hxin = REBNCONV(in_ch,out_ch,1,input_tensor)
    hx1 = REBNCONV(out_ch,mid_ch,1,hxin)
    hx = layers.MaxPool2D(pool_size=2,strides=2,padding='same')(hx1)
    hx2 = REBNCONV(mid_ch,mid_ch,1,hx)
    ...
    hx = layers.MaxPool2D(pool_size=2,strides=2,padding='same')(hx4)
    hx5 = REBNCONV(mid_ch,mid_ch,1,hx)
    hx6 = REBNCONV(mid_ch,mid_ch,2,hx5)#######bottle neck#########
 
    hx5d = REBNCONV(mid_ch*2,mid_ch,1,tf.concat([hx6,hx5],-1))
    hx5dup = _upsample_like(hx5d,hx4)
    hx4d = REBNCONV(mid_ch*2,mid_ch,1,tf.concat([hx5dup,hx4],-1))
    hx4dup = _upsample_like(hx4d,hx3)
    hx3d = REBNCONV(mid_ch*2,mid_ch,1,tf.concat([hx4dup,hx3],-1))
...
def RSU5(in_ch, mid_ch, out_ch, input_tensor):
    hxin = REBNCONV(in_ch,out_ch,1,input_tensor)
    hx1 = REBNCONV(out_ch,mid_ch,1,hxin)
    hx = layers.MaxPool2D(pool_size=2,strides=2,padding='same')(hx1)
    hx2 = REBNCONV(mid_ch,mid_ch,1,hx)
    ...
    hx = layers.MaxPool2D(pool_size=2,strides=2,padding='same')(hx3)
    hx4 = REBNCONV(mid_ch,mid_ch,1,hx)
    hx5 = REBNCONV(mid_ch,mid_ch,2,hx4)#######bottle neck#########
     
    hx4d = REBNCONV(mid_ch*2,mid_ch,1,tf.concat([hx5,hx4],-1))
    hx4dup = _upsample_like(hx4d,hx3)
    hx3d = REBNCONV(mid_ch*2,mid_ch,1,tf.concat([hx4dup,hx3],-1))
    hx3dup = _upsample_like(hx3d,hx2)
    hx2d = REBNCONV(mid_ch*2,mid_ch,1,tf.concat([hx3dup,hx2],-1))
...
def RSU4(in_ch, mid_ch, out_ch, input_tensor):
    hxin = REBNCONV(in_ch,out_ch,1,input_tensor)
    hx1 = REBNCONV(out_ch,mid_ch,1,hxin)
    hx = layers.MaxPool2D(pool_size=2,strides=2,padding='same')(hx1)
    hx2 = REBNCONV(mid_ch,mid_ch,1,hx)
    hx = layers.MaxPool2D(pool_size=2,strides=2,padding='same')(hx2)
    hx3 = REBNCONV(mid_ch,mid_ch,1,hx)
    hx4 = REBNCONV(mid_ch,mid_ch,2,hx3)#######bottle neck#########
     
    hx3d = REBNCONV(mid_ch*2,mid_ch,1,tf.concat([hx4,hx3],-1))
    hx3dup = _upsample_like(hx3d,hx2)
    hx2d = REBNCONV(mid_ch*2,mid_ch,1,tf.concat([hx3dup,hx2],-1))
    hx2dup = _upsample_like(hx2d,hx1)
    hx1d = REBNCONV(mid_ch*2,out_ch,1,tf.concat([hx2dup,hx1],-1))
...
def RSU4F(in_ch, mid_ch, out_ch, input_tensor):
    hxin = REBNCONV(in_ch,out_ch,1,input_tensor)
    hx1 = REBNCONV(out_ch,mid_ch,1,hxin)
    hx2 = REBNCONV(mid_ch,mid_ch,2,hx1)
    hx3 = REBNCONV(mid_ch,mid_ch,4,hx2)
    hx4 = REBNCONV(mid_ch,mid_ch,8,hx3)#######bottle neck#########
     
    hx3d = REBNCONV(mid_ch*2,mid_ch,4,tf.concat([hx4,hx3],-1))
    hx2d = REBNCONV(mid_ch*2,mid_ch,1,tf.concat([hx3d,hx2],-1))
    hx1d = REBNCONV(mid_ch*2,out_ch,1,tf.concat([hx2d,hx1],-1))
    return hx1d + hxin
...
def AttentionBlock(input_channel,mid_channel,input_tensor,gate):
    ...
    return out
##############################RSU-Net###########################
def RSUNET(in_ch,out_ch,is_muti_output,shape):
...
############No Attention#####################
def RSUNET1(in_ch,out_ch,is_muti_output,shape):
    '''指定输入tensor，返回RSU-Net Model'''
    input_tensor = tf.keras.Input(shape=shape)
    #stage 1                     
    hx1 = RSU7(in_ch,32,64,input_tensor)
    ...
    hx6_side = layers.Conv2D(4,3,1,padding='same')(hx6)
    hx6_side = _upsample_like(hx6_side,hx1)
    return Model(inputs=input_tensor,outputs=hx6_side)
def RSUNET2(in_ch,out_ch,is_muti_output,shape):
    '''指定输入tensor，返回RSU-Net Model'''
    input_tensor = tf.keras.Input(shape=shape)
    #stage 1                     
    hx1 = RSU7(in_ch,32,64,input_tensor)
    ...
    return Model(inputs=input_tensor,outputs=hx5_side)
def RSUNET3(in_ch,out_ch,is_muti_output,shape):
    '''指定输入tensor，返回RSU-Net Model'''
    input_tensor = tf.keras.Input(shape=shape)
    #stage 1                     
    hx1 = RSU7(in_ch,32,64,input_tensor)
    ...
    hx4_side = layers.Conv2D(4,3,1,padding='same')(hx4d)
    hx4_side = _upsample_like(hx4_side,hx1)
    return Model(inputs=input_tensor,outputs=hx4_side)
#%%
model=RSUNET(in_ch=3,out_ch=4,is_muti_output=False,shape=(128,800,3))
model1=RSUNET1(in_ch=3,out_ch=4,is_muti_output=False,shape=(128,800,3))
model2=RSUNET2(in_ch=3,out_ch=4,is_muti_output=False,shape=(128,800,3))
model3=RSUNET3(in_ch=3,out_ch=4,is_muti_output=False,shape=(128,800,3))
